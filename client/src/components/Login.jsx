...
const Login = () => {
  ...
  return (
    <div className='text-black'>
      <div className="w-full p-6 rounded-lg shadow-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 border">
        ...
        <form onSubmit={onSubmitHandler} action="">
            ...
            <div className='mt-4 w-20 center mx-auto'>
